...
The ESP32-C61 has 2MB Psram, supports WiFi-6 and uses much less power compared to ESP32-S3.
(My other project using Xaio ESP32-C6 without Psram works, but doesn't support media player while this setup does. Both C6 and C61 have only 1 I2S bus, so speaker and mic share the bus and can't listen while playing or play while listening.)
